            ...
            let shapes: { [name: string]: string } = {
                'circle': `
                    <svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" fill="#${this.fillColourHex}" class="bi bi-circle-fill" viewBox="0 0 16 16">
                      <circle cx="8" cy="8" r="7" style="stroke:#${this.strokeColourHex};stroke-width:0.5;" />
                    </svg>
                `,
                'cross': `
                    <svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" fill="#${this.fillColourHex}" class="bi bi-x-lg" viewBox="0 0 16 16">
                        <path style="stroke:#${this.strokeColourHex};stroke-width:0.5;" d="M 2.4365573,13.983865 6.5264837,7.7387676 2.820243,2.0161361 H 5.6448229 L 8.0448995,5.8611567 10.395995,2.0161361 h 2.800089 L 9.4735165,7.8285664 13.563443,13.983865 H 10.649064 L 7.9959183,9.8449572 5.3346089,13.983865 Z"/>
                    </svg>
                `,
                'heart': `
                    <svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" fill="#${this.fillColourHex}" class="bi bi-heart-fill" viewBox="0 0 16 16">
                        <path style="stroke:#${this.strokeColourHex};stroke-width:0.5;" d="M 8,1.7342811 C 12.137662,-2.5189889 22.482748,4.9237674 8,14.494091 -6.4827478,4.9246997 3.8623384,-2.5189889 8,1.7342811 Z"/>
                    </svg>
                `,
                'pin': `
                    <svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" fill="#${this.fillColourHex}" class="bi bi-geo-alt-fill" viewBox="0 0 16 16">
                        <path style="stroke:#${this.strokeColourHex};stroke-width:0.5;stroke-linecap:round" d="m 8,15.401616 c 0,0 5.550208,-5.259748 5.550208,-9.2503484 a 5.5502088,5.5502088 0 0 0 -11.1004168,0 C 2.4497912,10.141868 8,15.401616 8,15.401616 M 8,8.9263721 a 2.7751045,2.7751045 0 1 1 0,-5.550209 2.7751045,2.7751045 0 0 1 0,5.550209"/>
                    </svg>
                `,
                'square': `
                    <svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" fill="#${this.fillColourHex}" class="bi bi-square-fill" viewBox="0 0 16 16">
                        <path style="stroke:#${this.strokeColourHex};stroke-width:0.5;" d="M 0.64252759,2.4818957 A 1.8393681,1.8393681 0 0 1 2.4818957,0.64252759 H 13.518104 A 1.8393681,1.8393681 0 0 1 15.357472,2.4818957 V 13.518104 a 1.8393681,1.8393681 0 0 1 -1.839368,1.839368 H 2.4818957 A 1.8393681,1.8393681 0 0 1 0.64252759,13.518104 Z"/>
                    </svg>
                `,
                'diamond': `
                    <svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" fill="#${this.fillColourHex}" class="bi bi-diamond-fill" viewBox="0 0 16 16">
                        <path style="stroke:#${this.strokeColourHex};stroke-width:0.5;" d="m 7.0286953,1.0020604 c 0.5365237,-0.53652376 1.4060621,-0.53652376 1.9425858,0 l 6.0266409,6.0275665 c 0.536524,0.5365237 0.536524,1.4051371 0,1.9407358 L 8.9712811,14.997929 c -0.5365237,0.536524 -1.405137,0.536524 -1.9407358,0 L 1.0020539,8.9712878 a 1.3709106,1.3709106 0 0 1 0,-1.9407359 z"/>
                    </svg>
                `,
                'star': `
                ...
                'triangle': `
                    <svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" fill="#${this.fillColourHex}" class="bi bi-triangle-fill" viewBox="0 0 16 16">
                        <path style="stroke:#${this.strokeColourHex};stroke-width:0.5;" d="m 7.0752225,1.9158026 a 1.0685954,1.0685954 0 0 1 1.8534928,0 L 15.413103,12.948813 c 0.432167,0.735723 -0.087,1.670981 -0.926746,1.670981 H 1.5166353 c -0.84069136,0 -1.35891282,-0.936203 -0.92674638,-1.670981 z"/>
                    </svg>
                `,
                'house': `
                ...
                'lightning': `
                    <svg xmlns="http://www.w3.org/2000/svg" width="${this.size}" height="${this.size}" fill="#${this.fillColourHex}" class="bi bi-lightning-fill" viewBox="0 0 16 16">
                        <path style="stroke:#${this.strokeColourHex};stroke-width:0.5;" d="M 5.7412109,1.0412492 A 0.45535351,0.45535351 0 0 1 6.1783503,0.71430538 H 9.8211784 A 0.45535351,0.45535351 0 0 1 10.252854,1.3135506 L 8.631795,6.1785475 h 3.466151 a 0.45535351,0.45535351 0 0 1 0.359729,0.7349406 L 6.0827261,15.109851 A 0.45535351,0.45535351 0 0 1 5.2876788,14.69639 L 6.9278622,9.3660221 H 3.9015827 A 0.45535351,0.45535351 0 0 1 3.4644434,8.7822589 Z"/>
                    </svg>
                `,
                'person': `
