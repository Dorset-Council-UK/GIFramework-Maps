  ...
  private async renderPDF(
    ...
    try {
      ...
      if (northPointerCheckBox.checked) {
        ...
        await this.createNorthPointerBox(pdf, pageMargin, northPointerBase64Encoded, map);
      }
 ...
 */
  private async createNorthPointerBox(pdf: jsPDF, pageMargin: number, northPointerBase64Encoded: string, map: GIFWMap) {
    const olMap = map.olMap;
    ...
    const rotatedImage = await this.rotateBase64Image(northPointerBase64Encoded, mapRotationDegrees);
