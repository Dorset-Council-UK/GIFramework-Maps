...
export class Export {
  ...
  private async renderPDF(
    ...
    try {
      ...
      /* const northPointerString = "~/img/north-arrow.png";*/
      ...
      if (northPointerCheckBox.checked) {
        ...
        this.createNorthPointerBox(pdf, pageMargin, northPointerBase64Encoded);
      }
 ...
 * @param pdf
 * @param pageMargin
 * @param northPointerString - The image as a PNG
 */
  private createNorthPointerBox(pdf: jsPDF, pageMargin: number, northPointerBase64Encoded: string): void {
