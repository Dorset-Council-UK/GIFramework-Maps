...
export class Measure extends olControl {
    ...
    public init() {
        ...
        this._modifyControl = new Modify({ source: this._measureLayer.getSource(), style: this._modifyStyle })
    ...
    private addUIEvents() {
        ...
        areaMeasureButton.addEventListener('click', () => {
            if (this._areaMeasurementControlElement.classList.contains('ol-control-active')) {
                ...
                document.getElementById(this.gifwMapInstance.id).dispatchEvent(new Event('gifw-area-measure-start'))
            }
        ...
        lineMeasureButton.addEventListener('click', () => {
            if (this._lineMeasurementControlElement.classList.contains('ol-control-active')) {
                ...
                document.getElementById(this.gifwMapInstance.id).dispatchEvent(new Event('gifw-line-measure-start'))
            }
        })
