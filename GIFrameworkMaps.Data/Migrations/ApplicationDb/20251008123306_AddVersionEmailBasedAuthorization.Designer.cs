...
namespace GIFrameworkMaps.Data.Migrations.ApplicationDb
{
    ...
    [Migration("20251008123306_AddVersionEmailBasedAuthorization")]
    partial class AddVersionEmailBasedAuthorization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "authorization_type", new[] { "bearer", "none" });
            ...
            modelBuilder.Entity("GIFrameworkMaps.Data.Models.Authorization.URLAuthorizationRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<AuthorizationType>("AuthorizationType")
                        .HasColumnType("authorization_type");
                    ...
                    b.ToTable("URLAuthorizationRules", "giframeworkmaps");
                });
            ...
            modelBuilder.Entity("GIFrameworkMaps.Data.Models.Layer", b =>
                {
                    ...
                    b.Property<int?>("LayerDisclaimerId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GIFrameworkMaps.Data.Models.LayerDisclaimer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("LayerDisclaimers", "giframeworkmaps");
                });
            ...
            modelBuilder.Entity("GIFrameworkMaps.Data.Models.Print.PrintConfiguration", b =>
                {
                    ...
                    b.Property<string>("NorthArrowURL")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("GIFrameworkMaps.Data.Models.Search.SearchDefinition", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("SearchDefinition");
            ...
            modelBuilder.Entity("GIFrameworkMaps.Data.Models.VersionEmailBasedAuthorization", b =>
                {
                    b.Property<string>("EmailRegEx")
                        .HasColumnType("text");

                    b.Property<int>("VersionId")
                        .HasColumnType("integer");

                    b.HasKey("EmailRegEx", "VersionId");

                    b.HasIndex("VersionId");

                    b.ToTable("VersionEmailBasedAuthorizations", "giframeworkmaps");
                });
            ...
            modelBuilder.Entity("GIFrameworkMaps.Data.Models.Layer", b =>
                {
                    ...
                    b.HasOne("GIFrameworkMaps.Data.Models.LayerDisclaimer", "LayerDisclaimer")
                        .WithMany()
                        .HasForeignKey("LayerDisclaimerId");
