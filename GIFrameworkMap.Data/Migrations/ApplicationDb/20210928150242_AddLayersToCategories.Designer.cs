...
namespace GIFrameworkMaps.Data.Migrations.ApplicationDb
{
    ...
    [Migration("20210928150242_AddLayersToCategories")]
    partial class AddLayersToCategories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryLayer", b =>
                {
                    ...
                    b.HasKey("CategoriesId", "LayersId");
            ...
            modelBuilder.Entity("CategoryLayer", b =>
                {
                    b.HasOne("GIFrameworkMaps.Data.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GIFrameworkMaps.Data.Models.Layer", null)
                        .WithMany()
